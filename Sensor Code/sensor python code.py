...
while(counter < 50):
    ...
    print ("X-Axis of Rotation :" + str(xGyro)) #xGyro
    print ("Y-Axis of Rotation : " + str(yGyro))
    print ("Z-Axis of Rotation : " + str(zGyro))
    ...
    #line0 = str(counter) + "\n"
    line1 = str(xAccl) + " " + str(yAccl) + " " + str(zAccl) + "\n"
    line2 = str(xGyro) + " " + str(yGyro) + " " + str(zGyro) + "\n"
    line3 = str(xMag) + " " + str(yMag) + " " + str(zMag) + "\n"
